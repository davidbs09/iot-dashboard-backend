        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("""
                                ...
                                Desenvolvida como projeto de demonstração para o desafio técnico da Meta Telecom.
                                ...
                                como mencionado no desafio da Meta Telecom sobre plataforma de gestão
                                de hardwares homologados.
                                """)
                        .contact(new Contact()
                                .name("David Silva")
